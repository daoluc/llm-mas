...
def prepare_dataset(dataset):
    ...
    for item in dataset:
        ...
        # Delete mc2_targets as it's not needed
        del new_item['mc2_targets']
...
def prepare_and_save_dataset(output_file="./preprocessed_truthfulqa.json"):
    """Load TruthfulQA dataset, prepare it, and save to file."""
    import json
    import os
...
def load_prepared_dataset(input_file="./preprocessed_truthfulqa.json"):
    """Load prepared dataset from local JSON file."""
    import json
    ...
    try:
        ...
        raise FileNotFoundError(f"Dataset file not found at {input_file}. Please run prepare_and_save_dataset() first.")
...
def run_evaluation(ga:GroupArchitecture, dataset, datetime, n_threads=10):
    ...
    messages_file = open(f'results/messages_{str(ga)}.txt', 'a')
...
def main():
    ...
    # ga = GroupArchitecture(Topology.CROWDSOURCING, 6, PromptType.CHAIN_OF_THOUGHT)
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")

    # ga = GroupArchitecture(Topology.CROWDSOURCING, 6, PromptType.STEP_BACK_ABSTRACTION)
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.CROWDSOURCING, 6, PromptType.MIXED)
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.CROWDSOURCING, 6, PromptType.CHAIN_OF_THOUGHT, malicious_target='Y')
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.CROWDSOURCING, 6, PromptType.STEP_BACK_ABSTRACTION, malicious_target='Y')
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.CROWDSOURCING, 6, PromptType.MIXED, malicious_target='Y')
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")

    # ga = GroupArchitecture(Topology.BLACKBOARD, 6, PromptType.CHAIN_OF_THOUGHT)
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")

    # ga = GroupArchitecture(Topology.BLACKBOARD, 6, PromptType.STEP_BACK_ABSTRACTION)
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.BLACKBOARD, 6, PromptType.MIXED)
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.BLACKBOARD, 6, PromptType.CHAIN_OF_THOUGHT, malicious_target='Y')
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.BLACKBOARD, 6, PromptType.STEP_BACK_ABSTRACTION, malicious_target='Y')
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.BLACKBOARD, 6, PromptType.MIXED, malicious_target='Y')
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    ...
    # ga = GroupArchitecture(Topology.REFLECTION, 6, PromptType.STEP_BACK_ABSTRACTION)
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads//ga.group_size*2)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.REFLECTION, 6, PromptType.MIXED)
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads//ga.group_size*2)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.REFLECTION, 6, PromptType.CHAIN_OF_THOUGHT, malicious_target='Y')
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads//ga.group_size*2)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")

    # ga = GroupArchitecture(Topology.REFLECTION, 6, PromptType.STEP_BACK_ABSTRACTION, malicious_target='Y')
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads//ga.group_size*2)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.REFLECTION, 6, PromptType.MIXED, malicious_target='Y')
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads//ga.group_size*2)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    ga = GroupArchitecture(Topology.GROUP_CHAT, 6, PromptType.CHAIN_OF_THOUGHT)
    accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    print(f"Accuracy: {accuracy:.2%}")    
    print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    ga = GroupArchitecture(Topology.GROUP_CHAT, 6, PromptType.STEP_BACK_ABSTRACTION)
    accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    print(f"Accuracy: {accuracy:.2%}")    
    print(f"Results saved to results/results.csv and results/result_per_question.csv")  
    
    ga = GroupArchitecture(Topology.GROUP_CHAT, 6, PromptType.MIXED)
    accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    print(f"Accuracy: {accuracy:.2%}")    
    print(f"Results saved to results/results.csv and results/result_per_question.csv")   
    
    ga = GroupArchitecture(Topology.GROUP_CHAT, 6, PromptType.CHAIN_OF_THOUGHT, malicious_target='Y')
    accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    print(f"Accuracy: {accuracy:.2%}")    
    print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    ga = GroupArchitecture(Topology.GROUP_CHAT, 6, PromptType.STEP_BACK_ABSTRACTION, malicious_target='Y')
    accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    print(f"Accuracy: {accuracy:.2%}")    
    print(f"Results saved to results/results.csv and results/result_per_question.csv")
    ...
    # ga = GroupArchitecture(Topology.GROUP_CHAT, 2, PromptType.STEP_BACK_ABSTRACTION, malicious_target='Y')
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    ...
    # ga = GroupArchitecture(Topology.GROUP_CHAT, 4, PromptType.STEP_BACK_ABSTRACTION)
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.GROUP_CHAT, 4, PromptType.MIXED)
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
    
    # ga = GroupArchitecture(Topology.GROUP_CHAT, 4, PromptType.CHAIN_OF_THOUGHT, malicious_target='Y')
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")

    # ga = GroupArchitecture(Topology.GROUP_CHAT, 4, PromptType.STEP_BACK_ABSTRACTION, malicious_target='Y')
    # accuracy = run_evaluation(ga, dataset, current_datetime, n_threads=n_threads)
    # print(f"Accuracy: {accuracy:.2%}")    
    # print(f"Results saved to results/results.csv and results/result_per_question.csv")
